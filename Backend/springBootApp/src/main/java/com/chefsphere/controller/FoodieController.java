...
import com.chefsphere.dto.ApiResponse;
import com.chefsphere.dto.FoodieSignUpDto;
import com.chefsphere.dto.FoodieUpdateDto;
...
import com.chefsphere.exception_handler.FoodieConflictException;
import com.chefsphere.exception_handler.ResourceAlreadyExistsException;
import com.chefsphere.service.CreatorService;
import com.chefsphere.service.FoodieService;
...
//				serviceImpl.signUp(newUser);
	...
	@Transactional
	@PostMapping("followCreator")
	public ResponseEntity<?> followCreator(@RequestParam Long foodie_id, @RequestParam Long creator_id){			
	...
	@Transactional
	@DeleteMapping("unfollowCreator")
	public ResponseEntity<?> unfollowCreator(@RequestParam Long foodie_id, @RequestParam Long creator_id){			
		// get persistant foodie by id
		Foodie f = foodieService.findByIdWithCreators(foodie_id);
		...
		if(
			...
			// 
			Creator c = creatorService.findById(creator_id);
			// insert creator to set or following list
			...
			return ResponseEntity.ok("Foodie: "+foodie_id+" has unfollowed Creator: "+creator_id);
