...
//		        .requestMatchers(HttpMethod.POST, "/**").permitAll()
		        .requestMatchers(
		                ...
		                "/foodies/list/**",
		                "/foodies/signUp/**",
		                "/foodies/{foodie_id}/followCreator/{creator_id}/**",
		                "/creators/list/**",
		                "/creators/followers/**",
		                "/creators/signUp/**",
		                "/posts/**",
